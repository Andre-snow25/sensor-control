// Configurações de tipos, campos e opções do sistema 
// (SensorControl)
const SENSOR_TYPES = [
...
const APLICACAO_OPTS = ['Detecção de metal', 'Detecção de nível', 'Detecção de presença', 'Contagem de peças', 'Posicionamento de cilindro', 'Conexão de sensores', 'Segurança', 'Detecção de Posição', 'Motores elétricos'];
